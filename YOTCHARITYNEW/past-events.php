  ...
  <div class="well">
      <div class="media">
      	<a class="pull-left" href="#">
    		<img class="media-object"src="admin/pastevents/<?= $Image;?>" width = "400" height = "300">
  		</a>
    ...
    <div class="d-flex justify-content-center row">
        <div class="d-flex flex-column col-md-8">
            <div class="d-flex flex-row align-items-center text-left comment-top p-2 bg-white border-bottom px-4">
                <div class="profile-image"><img class="rounded-circle" src="admin/pastevents/<?= $Image;?>" width="70"></div>
            ...
            <div class="coment-bottom bg-white p-2 px-4">
                <div class="d-flex flex-row add-comment-section mt-4 mb-4"><img class="img-fluid img-responsive rounded-circle mr-2" src="admin/pastevents/<?= $Image;?>" width="38"><input type="text" class="form-control mr-3" placeholder="Add comment">
